...
int main(){
	...
	cout << "Testing Extensions PrintItemCost and ItemDescription" << endl;

	string describe;
    cin.ignore();
	cout << "Item Description Test: " << endl;
	getline(cin, describe);
	cout << endl;

	purchase1.SetDescription(describe);

	purchase1.PrintItemCost(purchase1.GetName(),  purchase1.GetQuantity(), purchase1.GetPrice(), costItem1);
	purchase1.PrintItemDescription(purchase1.GetName(), purchase1.GetDescription());
